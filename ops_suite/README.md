...
1. Clone the repository **or** download `OPS_Suite.zip` from this directory and extract it.
...
- **You are here**: this `ops_suite/` directory is the project home. It contains the Django settings package, feature apps, templates, middleware, and helper scripts.
- Key helpers alongside this README:
